...
Begin Menu MainMenuBar
   Begin DesktopMenuItem FileMenu
      ...
      Begin DesktopQuitMenuItem FileQuit
         ...
         Visible = True
      End
      Begin DesktopMenuItem FilePreferences
         SpecialMenu = 0
         Index = -2147483648
         Text = "Preferences"
         AutoEnabled = True
   ...
   Begin DesktopMenuItem HelpMenu
      ...
      AutoEnable = True
      Visible = True
      Begin DesktopMenuItem HelpSorry
         SpecialMenu = 0
         Index = 1
         Text = "Sorry, Cant help you"
         AutoEnabled = True
         AutoEnable = True
         SubMenu = True
         Visible = True
         Begin DesktopMenuItem SorryCanthelpyouPayMe
            SpecialMenu = 0
            Index = -2147483648
            Text = "Pay Me"
            AutoEnabled = True
         ...
         End
      End
      Begin DesktopMenuItem HelpFFMPEG
         SpecialMenu = 0
         Index = -2147483648
         Text = "FFMPEG"
         AutoEnabled = True
